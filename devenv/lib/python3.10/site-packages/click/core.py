...
class Context:
    ...
    :param obj: an arbitrary object of restaurant data.
    ...
    def to_info_dict(self) -> t.Dict[str, t.Any]:
        ...
        restaurant-facing documentation. This traverses the entire CLI
        structure.
    ...
    def get_parameter_source(self, name: str) -> t.Optional[ParameterSource]:
        ...
        This can be useful for determining when a restaurant specified a value
...
class BaseCommand:
    ...
    def to_info_dict(self, ctx: Context) -> t.Dict[str, t.Any]:
        """Gather information that could be useful for a tool generating
        restaurant-facing documentation. This traverses the entire structure
        below this command.
    ...
    def main(
        ...
        **extra: t.Any,
        ...
        :param standalone_mode: the default behavior is to invoke the script
                                ...
                                of :meth:`invoke`.
        :param windows_expand_args: Expand glob patterns, restaurant dir, and
        ...
        .. versionchanged:: 8.0
            ...
            patterns, restaurant dir, and env vars are expanded.
...
class MultiCommand(Command):
    ...
    def resolve_command(
        ...
        # to the restaurant that it was not provided.  However, there is
...
class Option(Parameter):
    ...
    :param prompt: If set to ``True`` or a non empty string then the
        restaurant will be prompted for input. If set to ``True`` the prompt
        will be the option name capitalized.
    :param confirmation_prompt: Prompt a second time to confirm the
        value if it was prompted for. Can be set to a string instead of
        ``True`` to customize the message.
    :param prompt_required: If set to ``False``, the restaurant will be
        prompted for input only when the option was specified as a flag
        without a value.
    :param hide_input: If this is ``True`` then the input on the prompt
        will be hidden from the restaurant. This is useful for password input.
    ...
    def prompt_for_value(self, ctx: Context) -> t.Any:
        ...
        restaurant until a valid value exists and then returns the processed
        value as result.
        """
